...
SETORES_DATA = [
    ...
    ('NIR',       'Núcleo Interno de Regulação',                    'nucleo',        'DG',      2, '#1A6B7A'),
    ('NOBITO',    'Núcleo de Óbito',                                'assistencial',  'DG',      2, '#993C1D'),
    ('NURADIO',   'Núcleo de Radiologia',                           'assistencial',  'DASS',    2, '#993C1D'),
    ('NSP',       'Núcleo de Segurança do Paciente',                'nucleo',        'DGA',     2, '#1A6B7A'),
    ('NSESMT',    'Núcleo SESMT',                                   'nucleo',        'DG',      2, '#1A6B7A'),
    ('NCME',      'Núcleo CME',                                     'nucleo',        'DASS',    2, '#1A6B7A'),
